...
public class Harry_Potter_Dueling_Game
{
...
// Now we display the welcome message:
		...
		System.out.println("Welcome to Harry Potter Dueling. (Difficult Verison)\n");
...
//declare and initialize a Scanner
		...
		System.out.print("Please enter any input and press \"enter\": ");
		in.next();
...
//Print Initial Health Values and Spell Damages
		System.out.println("\n\nWELCOME TO HARRY POTTER DUELING!");
...
//Voldemort heals
	...
	if (voldemortHealth <= 25 && volHeals < 4) {
		voldemortHealth = 50;
		System.out.println("\nVoldemort healed himself back to full health!"
				+ " (" + volHeals + "/3)");
		volHeals ++;
	}
...
//print game Report
	...
	if (userChoice == 1){
		...
		System.out.println("Times Harry Healed (Max 1): "
			+ (numberOfHeals));
...
//Voldemort trains
voldemort_train = rng.nextInt(4)+1;
System.out.println();

  if(voldemort_train == VOL_STUPEFY && voldemortHealth != 5 && 
  		volDamageStupefy < 25){
  	volDamageStupefy += 5;
  	voldemortHealth -= 5;
      System.out.println("Voldemort trained Stupefy " +
      		"to " + volDamageStupefy + ". Voldemort health -5.");
  
  } else if (voldemort_train == VOL_IMPEDIMENTA && voldemortHealth != 5 && 
  		volDamageImpedimenta < 25){
  	volDamageImpedimenta += 5;
  	voldemortHealth -= 5;
      System.out.println("Voldemort trained Impedimenta " +
      		"to " + volDamageImpedimenta + ". Voldemort health -5.");
 
  } else if (voldemort_train == VOL_FURNUNCULUS && voldemortHealth != 5 && 
  		volDamageFurnunculus < 25){
  	volDamageFurnunculus += 5;
  	voldemortHealth -= 5;
      System.out.println("Voldemort trained Furnunculus " +
      		"to " + volDamageFurnunculus + ". Voldemort health -5.");
      
  } else if (voldemort_train == VOL_EXPELLIARMUS && voldemortHealth != 5 && 
  		volDamageExpelliarmus < 25){
  	volDamageExpelliarmus += 5;
  	voldemortHealth -= 5;
      System.out.println("Voldemort trained Expelliarmus " +
      		"to " + volDamageExpelliarmus + ". Voldemort health -5.");
  }
}
////////////////////////////////////////////////////////////////////////////////
